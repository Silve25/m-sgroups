...
const translations = {
  ...
  "nl": {
    ...
    "nav_loan_request": "Leningsaanvraag",
    "lang_fr": "Frans",
    "lang_en": "Engels",
    "lang_pl": "Pools",
    "lang_de": "Duits",
    ...
    "lang_pt": "Portugees",
    "lang_nl": "Nederlands",
    "footer_about": "Particuliere leningsdiensten sinds 2009",
    "footer_quick_links": "Snelle links",
    "footer_services": "Onze diensten",
    "footer_contact": "Contact",
    "footer_newsletter": "Nieuwsbrief",
    "footer_newsletter_desc": "Schrijf u in voor onze nieuwsbrief om ons nieuws en financieel advies te ontvangen.",
    "newsletter_placeholder": "Uw e-mail",
    "footer_rights": "Alle rechten voorbehouden.",
    "footer_privacy": "Privacybeleid",
    "footer_terms": "Gebruiksvoorwaarden",
    "preloader_loading": "Laden...",
    "hero_title": "Laten we samen uw financiële toekomst opbouwen",
    "hero_subtitle": "Magdeleine Solutions ondersteunt u bij al uw projecten met op maat gemaakte, transparante financieringsoplossingen die passen bij uw situatie.",
    "hero_btn_services": "Ontdek onze diensten",
    "hero_btn_contact": "Contacteer ons",
    "hero_scroll": "Ontdek",
    "about_title": "Wie zijn wij?",
    "about_subtitle": "Ontdek onze unieke aanpak en onze inzet voor uw financieel succes",
    "about_heading": "Financiële expertise tot uw dienst",
    "about_btn": "Onze diensten",
    "features_title": "Onze 3 pijlers",
    "features_subtitle": "De kernwaarden die onze aanpak sturen en uw tevredenheid garanderen",
    "feature1_title": "Persoonlijke begeleiding",
    "feature2_title": "Transparantie & educatie",
    "feature3_title": "Maatwerkoplossingen",
    "services_title": "Onze diensten",
    "services_subtitle": "Financiële oplossingen afgestemd op al uw behoeften",
    "services_tab_all": "Alle diensten",
    "services_tab_personal": "Particulieren",
    "services_tab_professional": "Professionals",
    "services_tab_advice": "Advies",
    "service_simulate": "Simuleer een lening",
    "service_contact": "Contacteer ons",
    "stat1_label": "Jaren ervaring",
    "stat2_label": "Tevreden klanten",
    "stat3_label": "Bankpartners",
    "stat4_label": "Tevredenheidspercentage (%)",
    "testimonials_title": "Getuigenissen",
    "cta_title": "Klaar om uw project te realiseren?",
    "cta_btn_request": "Een aanvraag indienen",
    "cta_btn_contact": "Contacteer ons",
    ...
    "sim_title": "Leningsimulatie",
    "sim_subtitle": "Bereken uw maandlasten en krijg een gedetailleerd overzicht van uw lening",
    "sim_form_title": "Leningparameters",
    "sim_amount_borrowed": "Leenbedrag",
    "sim_duration": "Looptijd lening",
    "sim_rate": "Rentevoet",
    "sim_type": "Type lening",
    "sim_calculate": "Bereken",
    "sim_results_title": "Resultaten van de simulatie",
    "sim_monthly": "Maandelijkse aflossing",
    "sim_total_interest": "Totale interestkosten",
    "sim_total_cost": "Totale kredietkosten",
    "sim_table_year": "Jaar",
    "sim_table_principal": "Terugbetaald kapitaal",
    "sim_table_interest": "Betaalde interesten",
    "sim_table_remaining": "Resterend kapitaal",
    "sim_download": "Samenvatting in PDF downloaden",
    "form_title": "Leningsaanvraag",
    "form_subtitle": "Vul het onderstaande formulier in om uw financieringsaanvraag in te dienen",
    "form_header": "Aanvraagformulier lening",
    "form_required": "Alle velden gemarkeerd met een sterretje (*) zijn verplicht",
    "form_section1": "Persoonlijke informatie",
    ...
    "form_address": "Volledig adres",
    "form_section2": "Informatie over de lening",
    "form_loan_type": "Type lening",
    "form_loan_amount": "Leenbedrag (€)",
    "form_loan_duration": "Looptijd lening (maanden)",
    "form_loan_purpose": "Doel van de lening",
    "form_submit": "Mijn aanvraag indienen",
    "form_success_title": "Aanvraag succesvol verzonden!",
    "form_back_home": "Terug naar startpagina",
    "bio_title": "Serge Magdeleine",
    "bio_subtitle": "Oprichter en Directeur van Magdeleine Solutions groups",
    "bio_heading": "Professionele loopbaan",
    "bio_quote": "Financiën moeten in dienst staan van de mens. Onze missie is om de toegang tot financieringsoplossingen voor iedereen te democratiseren, met transparantie en vertrouwen in onze klantenrelatie.",
    "bio_contact_btn": "Contacteer Serge Magdeleine"
  },
"en": {
